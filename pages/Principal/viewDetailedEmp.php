...
<body>
    ...
    <section class="home-section">
        ...
        <div class="container">
            ...
            <div class=" bg-white shadow pl-5 pr-5 pb-3 pt-4 mt-5 rounded-lg">

                <div class="col-md-12 col-sm-12 py-3">
                    <h4> Recently Applied Leaves <i id="leaves" class="fa-solid fa-caret-down ml-3 clickable"></i> </h4>
                </div>

                <div class="form-row" id="leaves-container">
                    ...
                    <table class="tablecontent">
                        ...
                        <tbody id="tbody">
                            ...
                            <?php
                                    $data =  $user->recentlyAppliedLeaveOfEmp( $empID );
