    ...
    <section class="home-section">
        ...
        <div class="container clg-12  bg-white rounded-lg " style="transition: all all 0.5s ease; border-right:6px solid #11101D">
            <div class="historycontent">
                ...
                <div class="box ml-2 collapse-containt-privious "> <!--the class  collapse-content are use for hide div  -->
                    <div class="box-body">
                        <table width="100%" class="table table-hover" id="dataTables-example">
                            <thead>
                                <tr>
        ...
        <div class="content mt-3 rounded-lg dash_table " style="margin: auto;">
        <div class="container bg-white rounded-lg " style="transition: all all 0.5s ease; border-right:6px solid #11101D">
            <div class="historycontent">
                ...
                <!-- below div shows Previous Request in table form  -->
                <div class="box ml-2  collapse-containt-privious-adjustment "> <!--the class  collapse-content are use for hide div  -->
                    <div class="box-body">
                        <table width="100%" class="table table-hover" id="dataTables-example">
                            <thead>
                                <tr>
